...
const VISIBLE_COUNT = 5; // total visible cards (center + 2 on each side)
...
export function CoverflowCarousel({ items }: CoverflowCarouselProps) {
  ...
  // Build array of visible positions relative to center
  const getCardStyle = (offset: number) => {
    ...
    const translateX = direction * absOffset * 62; // % offset from center
  ...
  // Get items to render (center + neighbors)
